...
>
> **Scope:** Template repo `workflow-orchestration-queue-zulu78-b` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
