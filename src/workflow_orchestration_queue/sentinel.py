"""
workflow-orchestration-queue Sentinel Orchestrator
...
logger = logging.getLogger("workflow-orchestration-queue.sentinel")
...
class Sentinel:
    """Sentinel orchestrator that polls GitHub for tasks and dispatches workers."""
...
async def _main() -> None:
    ...
    assert GITHUB_ORG is not None, "GITHUB_ORG must be set"
    assert GITHUB_REPO is not None, "GITHUB_REPO must be set"
